  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 sticky bottom-0 left-0 right-0 md:hidden bg-white shadow-lg border-t border-gray-200 z-50">
        <button className="w-full flex items-center justify-center h-14 text-black text-sm font-medium active:bg-[#aba2a2] active:scale-95 transition-all">
          <Link href="/" className="text-sm font-medium hover:text-primary">Home</Link>
        </button>
        <button className="w-full flex items-center justify-center h-14 text-black text-sm font-medium active:bg-[#aba2a2] active:scale-95 transition-all">
          <Link href="/shoppe" className="text-sm font-medium hover:text-primary">Products</Link>
        </button>

        <button className="w-full flex items-center justify-center h-14 text-black text-sm font-medium active:bg-red-500 active:text-white active:scale-95 transition-all">
